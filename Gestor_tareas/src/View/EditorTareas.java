...
public class EditorTareas extends JFrame {
	...
	public EditorTareas(Model model, Tarea t) {
		this.model = model;
		this.tareaInicial = t;
		setSize(300, 400);
	...
	private void placeComponents(JPanel panel) {
		...
		nombreText.setText(tareaInicial.getNombre());
		...
		editarButton.setBounds(170, 290, 100, 25);
		...
		editarButton.setActionCommand("agregar");
	...
	public void agregarTarea(ActionEvent e) {
		if (!nombreText.getText().isEmpty()
			...
			//Tarea con nueva informaci�n y el mismo id
